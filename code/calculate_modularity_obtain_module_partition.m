function [modularity, module_partition] = calculate_modularity_obtain_module_partition(intra_data,inter_data,method,layer,iter,networktype,inter_links_type)
