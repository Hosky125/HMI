...
Q_Random_total=zeros(1,9);%monolayer modularity
HMI_Random_total=zeros(1,9);%monolayer HMI
Q_multilayer_Random_total=zeros(1,9);%multilayer modularity
HMI_multilayer_Random_total=zeros(1,9);%multilayer HMI
for i=1:9
    i
    ...
    csvwrite('HMI_monolayer_total_SpaNet_Raw.csv', HMI_Random_total);
    csvwrite('Q_mean_max_total_SpaNet_Raw.csv', Q_Random_total);
    csvwrite('Q_multilayer_max_total_SpaNet_Raw.csv', Q_multilayer_Random_total);
    csvwrite('HMI_multilayer_total_SpaNet_Raw.csv', HMI_multilayer_Random_total);
end
