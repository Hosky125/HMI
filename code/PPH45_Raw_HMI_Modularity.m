...
for pph_index=1:45
    ...
    csvwrite('HMI_monolayer_total_PPH_Raw.csv', HMI_monolayer_total);
    csvwrite('HMI_multilayer_total_PPH_Raw.csv', HMI_multilayer_total);
    csvwrite('Q_mean_max_total_PPH_Raw.csv', Q_mean_max_total);
    csvwrite('Q_multilayer_max_total_PPH_Raw.csv', Q_multilayer_max_total);
end