...
for j=1:87
    ...
    csvwrite('HMI_monolayer_total_PHP_Hybrid_NullModel.csv', HMI_monolayer_total);
    csvwrite('HMI_multilayer_total_PHP_Hybrid_NullModel.csv', HMI_multilayer_total);
    csvwrite('Q_mean_max_total_PHP_Hybrid_NullModel.csv', Q_mean_max_total);
    csvwrite('Q_multilayer_max_total_PHP_Hybrid_NullModel.csv', Q_multilayer_max_total);
