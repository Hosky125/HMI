...
for ID=1:10
    ...
    csvwrite('HMI_monolayer_total_TemNet_Hybrid_NullModel.csv', HMI_Random_total);
    csvwrite('HMI_multilayer_total_TemNet_Hybrid_NullModel.csv', HMI_multilayer_Random_total);
    csvwrite('Q_mean_max_total_TemNet_Hybrid_NullModel.csv', Q_Random_total);
    csvwrite('Q_multilayer_max_total_TemNet_Hybrid_NullModel.csv', Q_multilayer_Random_total);
